...
const tableEntityMapping = {
  ...
  TO0_DEPT_MAST: { entityName: "Department", apiPath: "/department", alias: "dept" },
  TO0_DEPT_MAST_HISTORY: { entityName: "DepartmentHistory", apiPath: "/department" },
  ...
  TO0_GLOBAL_SETTING: { entityName: "GlobalSetting", apiPath: "/siteadmin/global-setting" },
  TO0_SETTING_INFO: { entityName: "SettingInfo", apiPath: "/siteadmin/setting" },
  ...
  TM0_ADMIN_MENU: { entityName: "AdminMenu", apiPath: "/siteadmin/admin-menu" },
  TM0_ADMIN_MENU_ACL: { entityName: "AdminMenuAcl", apiPath: "" },
  TM0_MENU: { entityName: "Menu", apiPath: "/siteadmin/menu" },
  ...
  TAS_DOC_TYPE: { entityName: "ApprovalDocType", apiPath: "/siteadmin/approval-doc-type" },
  TAS_DOC_DATA_MAPPING: { entityName: "ApprovalDocDataMapping", apiPath: "/siteadmin/sample-doc-mapping" },
  ...
  TAS_SAMPLE_DOC: { entityName: "ApprovalSampleDoc", apiPath: "/siteadmin/sample-doc" },
  ...
  TRS_RECORDS: { entityName: "RegistrationRecords", apiPath: "/siteadmin/record" },
  TRS_RECORDS_SUB: { entityName: "RegistrationRecordsSub", apiPath: "" },
  TRS_REGISTRATION: { entityName: "RegistrationDoc", apiPath: "/siteadmin/registration" },
  ...
  TRS_U_B_CODE: { entityName: "RegistrationUnitCode", apiPath: "/siteadmin/registration-unit-code" },
